...
SimpleTokenAuthentication.configure do |config|
  ...
  config.header_names = {
    ...
    # admin: { authentication_token: 'X-Admin-Token', phone: 'X-Admin-Phone' }, 
    administrator: { authentication_token: 'X-Administrator-Token', phone: 'X-Administrator-Phone' }
    
  }
  
  config.identifiers = { user: :email, administrator: :phone}
  # config.identifiers = { admin: :phone }
